...
$naglowek = "Opad, lokalizacja - {$nazwa}";
...
//podziałki na lini czasu
for($i=1; $i<24; $i++)
{
$d_i=mktime($godzina+$i,$minuta,0,$miesiac,$dzien,$rok);
...
imageline($image,1000-(($rys_t_1/3600)*40),$wys_w_h-20-($rys_h_1*$skala_y),1000-(($rys_t_2/3600)*40),$wys_w_h-20-($rys_h_2*$skala_y),$czarny);
if ($i+3<$il_tab_pun) {
...
imageline($image,1000-(($rys_t_2/3600)*40),$wys_w_h-20-($rys_h_2*$skala_y),1000-(($rys_t_3/3600)*40),$wys_w_h-20-($rys_h_3*$skala_y),$szary);
}

/*

//pobierz prognozy na najbliższe 2h 
